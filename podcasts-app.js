/* =========================================================
   52 LAUNCH — PODCASTS RENDERER
   =========================================================
   Reads the PODCASTS array from podcasts-data.js and builds
   cards with video banners + optional client contact block.
   You should not need to edit this file — edit
   podcasts-data.js instead.
   ========================================================= */
...
function renderPodcasts() {
  ...
  grid.innerHTML = "";
  window.PODCASTS.forEach((item) => grid.appendChild(createPodcastCard(item)));
}
